    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-8 py-10">
            ...
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-900">Register as Seller</h2>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                    <p>After registration, your account will be pending approval. An admin will review and approve your account before you can start selling.</p>
                </div>
            </div>
        </div>
    </div>
