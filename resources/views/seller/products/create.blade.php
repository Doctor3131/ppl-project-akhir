...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Isi detail untuk menambahkan produk baru ke toko Anda</p>
    </div>

    <!-- Product Form -->
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <form method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data" class="px-8 py-10">
            @csrf
