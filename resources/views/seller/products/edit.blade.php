...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            <a href="{{ route('seller.dashboard') }}" class="text-indigo-600 hover:text-indigo-800 mr-4">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <form method="POST" action="{{ route('seller.products.update', $product->id) }}" enctype="multipart/form-data" class="px-8 py-10">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                @if($product->image)
                    <div>
                        ...
                        <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="h-48 w-auto rounded-lg border border-gray-300">
                    </div>
                @endif
                ...
                <div id="imagePreview" class="hidden">
                    ...
                    <img id="preview" src="" alt="Preview" class="h-48 w-auto rounded-lg border border-gray-300">
                </div>
            </div>
